...
namespace FantasyTennis
{
    class MatchSimulator
    {
        ...
        {
            return p1.currentFormRate * (0.5 * h2hCourt + 0.35 * h2hLast10 + 0.15 * p1.winRates.getWinRate(this.courtType));
        }

        private double getWinCoef5Sets(TennisDB.TennisPlayer p1, double h2hCourt, double h2hLast10, double h2h5Sets)
        {
            return p1.currentFormRate * (0.4 * h2h5Sets + 0.35 * h2hCourt + 0.15 * h2hLast10 + 0.1 * p1.winRates.getWinRate(this.courtType));
        }
